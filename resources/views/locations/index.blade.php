...
<div class="row">
	<div class="col-12">
		<div class="d-flex justify-content-between align-items-center mb-4 text-white rounded p-3" style="background-color: #023c77ff;">
			<h1 class="mb-0"><i class="fas fa-map-marker-alt me-2"></i>Locais Cadastrados</h1>
...
<div class="row">
	<div class="col-md-8">
		<div class="card">
			<div class="card-header">
				<h5 class="card-title mb-0"><i class="fas fa-map me-2"></i>Mapa Interativo</h5>
			</div>
			<div class="card-body">
				<div id="map"></div>
			</div>
	...
	<div class="col-md-4">
		<div class="card">
			<div class="card-header">
				<h5 class="card-title mb-0"><i class="fas fa-list me-2"></i>Lista de Locais</h5>
			</div>
			<div class="card-body">
